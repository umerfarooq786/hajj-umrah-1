<div class="bg-white w-full text-black flex items-center justify-between p-5 md:p-10 lg:mt-10">
    ...
    <div class="w-full md:w-[33%] flex items-center justify-between md:justify-center">
        ...
        <img src="{{ asset('images/home/burger-icon2.png') }}" alt="" class="cursor-pointer h-[30px] md:hidden"
            onclick="showNav()">
    </div>
    <div class="hidden md:flex w-[33%] items-center justify-end gap-5y gap-3 lg:gap-7 ">
        <a href="https://www.facebook.com/profile.php?id=61557448243394" target="_blank"><img
        ...
        <a href="https://www.instagram.com/fastline.pk/" target="_blank"><img
                src="{{ asset('images/home/instagram.svg') }}" alt="" class="hover:scale-90 transition-all"></a>
...
<div class="bg-first text-white w-full h-[70px] hidden md:flex items-center justify-center gap-10 ">
    ...
    <div href="#" class="relative font-semibold text-sm py-5 cursor-pointer group">
        ...
        <div
            ...
            <a href="/predefined-package/umrah" class="font-semibold hover:bg-first hover:text-white text-sm p-2 ">Pre
                Defined</a>
        </div>
    </div>
    <div href="#" class="relative font-semibold text-sm py-5 cursor-pointer group">
    ...
    <div href="#" class="relative font-semibold text-sm py-5 cursor-pointer group">
        ...
        <div
            class="absolute bg-white w-[200px] text-black hidden group-hover:flex flex-col border border-r-gray-200 shadow-md top-[100%] left-0  ">
            <a href="/hotel-city/makkah" class="font-semibold hover:bg-first hover:text-white text-sm p-2 ">Hotels In
                Makkah</a>
            <a href="/hotel-city/madinah" class="font-semibold hover:bg-first hover:text-white text-sm p-2 ">Hotels In
                Madinah</a>
            <a href="/hotel-city/jeddah" class="font-semibold hover:bg-first hover:text-white text-sm p-2 ">Hotels In
                Jeddah</a>
        </div>
    </div>
    ...
    <div class="bg-white text-black w-full h-full flex flex-col items-center justify-start py-20 px-10">
        <div class="w-full flex items-center justify-between">
            ...
            <img src="{{ asset('images/home/cross-icon3.png') }}" alt=""
                class="h-[30px] md:hidden cursor-pointer" onclick="hideNav()">
        </div>
        ...
        <div class="w-full flex flex-1 flex-col items-center justify-center gap-5">
            ...
            <div href="#" class="relative text-lg  cursor-pointer group">
                ...
                <div
                    ...
                    <a href="/home_page#pre-defined"
                        class="font-semibold hover:bg-first hover:text-white text-sm p-2 ">Pre Defined</a>
                </div>
            </div>
            <div href="#" class="relative text-lg  cursor-pointer group">
                HOTELS
        ...
        <div class="flex items-center gap-5 ">
            <a href="#"><img src="{{ asset('images/home/facebook-f.svg') }}" alt=""
                    class=""></a>
            <a href="#"><img src="{{ asset('images/home/instagram.svg') }}" alt=""
                    class=""></a>
            <a href="#"><img src="{{ asset('images/home/youtube.svg') }}" alt="" class=""></a>
            <div class="flex gap-3 items-center">
                <a href="#"><img src="{{ asset('images/home/pakistan.png') }}" alt=""
                        class=""></a>
                <p>PK</p>
            </div>
        </div>
