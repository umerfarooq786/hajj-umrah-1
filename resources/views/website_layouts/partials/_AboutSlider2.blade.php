<swiper-container class="mySwiper" init="false" navigation-prev-el="#my-prev-button" navigation-next-el="#my-next-button">
    <swiper-slide>
        ...
        <div class="text-white">
            ...
            <div class=" text-[12px] space-x-10 mt-10">
                ...
                <a href="#"><i
                        class="fa-brands fa-linkedin hover:-translate-y-1 transition duration-300 w-[20px] h-[20px]"></i></a>
                <a href="#"><i
                        class="fa-regular fa-envelope hover:-translate-y-1 transition duration-300 w-[20px] h-[20px]"></i></a> --}}
            </div>
    ...
    <swiper-slide>
        <img src="{{ asset('images/about/team2.jpg') }}" alt="">
        <div class="text-white">
            {{-- <h4 class="text-[23px] font-semibold mt-5">Aqeel Sb</h4> --}}
    ...
    <swiper-slide>
        <img src="{{ asset('images/about/team3.jpg') }}" alt="">
        <div class="text-white">
            {{-- <h4 class="text-[23px] font-semibold mt-5">Aqeel Sb</h4> --}}
