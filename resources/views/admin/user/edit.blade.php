                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control border-primary"
                                            placeholder="First Name" value="{{$route->first_name}}" name="first_name" >
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="date" value="{{$route->dob}}" class="form-control border-primary" name="dob"
                                            >
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control border-primary" value="{{$route->gender}}" name="gender" >
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" value="{{$route->id_card}}" class="form-control border-primary"
                            ...
                            <div class="col-md-6 row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control border-primary"
                                        placeholder="Designation" value="{{$route->designation}}" name="designation" >
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6 row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control border-primary" placeholder="Address"
                                        name="address" value="{{$route->address}}" >
                                </div>
                            </div>
                        </div>
                        <div class="row">
