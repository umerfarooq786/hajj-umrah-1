...
>>>>>>> c95b705b6eb2a96ddf50faaef153c62235e84dbb
            ...
            <li class="nav-item"><a href="{{ request()->routeIs('transports.index') ? 'active' : '' }}"><i
                        class="la la-car"></i><span class="menu-title" data-i18n="nav.dash.main">Transport</span></a>
                <ul class="menu-content">
                    @can('transports-create')
                        <li class="{{ request()->routeIs('transports.create') ? 'active' : '' }}">
                            <a class="menu-item" href="{{ route('transports.create') }}" data-i18n="nav.dash.ecommerce">Add
                                Transport</a>
                        </li>
                    @endcan
                    @can('transports-list')
                        <li class="{{ request()->routeIs('transports.index') ? 'active' : '' }}">
                            <a class="menu-item" href="{{ route('transports.index') }}" data-i18n="nav.dash.ecommerce">View
                                Transport</a>
                        </li>
                    @endcan
                </ul>
            ...
            @if (auth()->user()->can('hotels-create') || auth()->user()->can('hotels-list') || auth()->user()->can('add-weekends-days'))
                ...
                <ul class="menu-content">
                    ...
                    @can('add-weekends-days')
                        <li class="{{ request()->routeIs('weekends.index') ? 'active' : '' }}">
                            <a class="menu-item" href="{{ route('weekends.index') }}" data-i18n="nav.dash.ecommerce">Add
                                Weekend Days</a>
                        </li>
                    @endcan
                </ul>
            ...
            <li class="nav-item"><a href=""><i class="la la-user"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    @can('packages-create')
                        <li class="">
                            <a class="menu-item" href="{{ route('packages.create') }}" data-i18n="nav.dash.ecommerce">Add
                                Predefine Packages</a>
                        </li>
                    @endcan
                    @can('packages-list')
                        <li class="">
                            <a class="menu-item" href="{{ route('packages.index') }}" data-i18n="nav.dash.ecommerce">View
                                Predefine Packages</a>
                        </li>
                    @endcan
                </ul>
