...
<div class="bg-[#e2efff] flex">
    <div class=" mx-auto py-10 max-md:px-10 max-lg:px-20 lg:pl-44 lg:w-[50%]">
        ...
        <p class="text-gray-500 mt-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio itaque neque ipsam, sapiente nam placeat eligendi asperiores perspiciatis. Natus aperiam tempore consectetur facere ipsam iure labore rerum eligendi asperiores fugit.</p>
        <a href="#" class="inline-block mt-5 py-3 px-5 rounded-full uppercase bg-red-500 hover:bg-opacity-80 text-xs text-white">Apply Now</a>
        <div class="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="flex space-x-4">
                <img src="{{asset('images/home/luggage.png')}}" alt="logo" class="object-contain h-[40px] w-[50px]">         
                <div>
                    <h4 class="text-[18px] font-semibold">Free Luggage</h4>
                    <p class="text-[14px] text-gray-500">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam esse aliquid obcaecati sed quaerat.</p>
                </div>
            </div>
            <div class="flex space-x-4">
                <img src="{{asset('images/home/customer-care.png')}}" alt="logo" class="object-contain h-[40px] w-[50px]">         
                <div>
            ...
            <div class="flex space-x-4">
                <img src="{{asset('images/home/reception-bell.png')}}" alt="logo" class="object-contain h-[40px] w-[50px]">         
                <div>
    ...
    <div class="max-lg:hidden w-[50%]  bg-no-repeat " style="background-image:url({{asset('images/home/masjid.png')}}); background-position: -504px ">        
    </div>
</div>
...
<div class=" bg-white" >
    <div class="flex max-lg:flex-col w-[80%] mx-auto py-20 gap-20">
        ...
        <div class=" lg:w-[60%]">
            ...
            <p class="text-gray-500 mt-3 leading-7">Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio itaque neque ipsam, sapiente nam placeat eligendi asperiores perspiciatis. Natus aperiam tempore consectetur facere ipsam iure labore rerum eligendi asperiores fugit.</p>            
            ...
            <a href="#" class="inline-block mt-8 py-3 px-5 rounded-full uppercase bg-red-500 hover:bg-opacity-80 text-xs text-white">Apply Now</a>
        </div>    
    </div>
</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div class="rounded-md overflow-hidden border border-gray-200 pb-7 shadow-sm">
                <div class="bg-[#2a2a2a] text-white p-8 relative h-[150px]">
                    ...
                    <a href="#" class="py-4 px-7 rounded-sm bg-[#e2efff] inline-block text-xs font-semibold text-black absolute bottom-[-20px]">GET STARTED</a>
                </div>
                <div class="px-5">
            ...
            <div class="rounded-md overflow-hidden border border-gray-200 pb-7 shadow-sm">
                <div class="bg-[#e2efff] text-white p-8 relative h-[150px]">
                    ...
                    <p class="text-red-500 mt-[-5px]">$2000 USD / Person</p>
                    <a href="#" class="py-4 px-7 rounded-sm bg-red-500 inline-block text-xs font-semibold text-white absolute bottom-[-20px]">GET STARTED</a>
                </div>
                <div class="px-5">
                    <div class="flex gap-3 mt-14 items-center">
                        <img src="{{asset('images/home/tick2.png')}}" class='h-[25px] w-[25px]' >                   
